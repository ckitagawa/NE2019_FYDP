...
PLATFORM_LIB := stm32f4xx
PLATFORM_EXT := .elf

# Architecture dependent variables
ARCH_CFLAGS := -mlittle-endian -mcpu=cortex-m4 -mthumb -mfloat-abi=hard -mfpu=fpv4-sp-d16 -mthumb-interwork
...
CDEFINES := USE_STDPERIPH_DRIVER STM32F410xx HSE_VALUE=32000000 PLL_M=32
CFLAGS := -Wall -Wextra -g3 -Os -std=c11 -Wno-discarded-qualifiers \
					-Wno-unused-variable -Wno-unused-parameter -Wno-sign-conversion -Wpointer-arith \
					-ffunction-sections -fdata-sections \
					$(ARCH_CFLAGS) $(addprefix -D,$(CDEFINES))

# Linker flags
LDFLAGS := -L$(LDSCRIPT_DIR) -Tstm32f4.ld -Wl,--gc-sections -Wl,--undefined=uxTopUsedPriority \
...
OPENOCD_CFG := -s $(OPENOCD_SCRIPT_DIR) \
               ...
               -f $(SCRIPT_DIR)/stm32f4-openocd.cfg \
